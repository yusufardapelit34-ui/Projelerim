	...
	<?php
		...
		if($_SESSION['kullanici'])
		{
			...
			<div class="container">
				...
				<h2 class="page-header">Admin sayfasına hoş geldin Sihirbaz ; <?php echo $_SESSION['kullanici'] ?></h2>
				<a href="cık.php" class="btn btn-danger"><i class="glyphicon glyphicon-log-out"></i> Çıkış</a>


					<h1 class="page-header text-primary"> Haberleri Sil İşlemi</h1>
				<table class="table">
					<tr>
						<th>Haber id</th>
						<th>Haber Başlık</th>
